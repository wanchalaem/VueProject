...
<v-container fluid grid-list>
  <v-layout row>
      <v-flex xs6 >
          ...
          style="color:blue;"
          ></v-text-field>
          <v-btn @click="signin" class="box-blue white--text">sign in</v-btn>
          <v-btn @click="clear" class="box-blue white--text">clear</v-btn>
          <v-btn @click="signup" class="box-blue white--text">sign up</v-btn>
        </v-flex>
...
<v-flex xs6 class="pd-20">
  ...
  <v-divider class="mrt-20"></v-divider>
    ...
    <!-- <v-jumbotron :gradient="gradient" dark src="https://cdn.vuetifyjs.com/images/parallax/material2.jpg" class="shadow">
    ...
    <v-footer dark height="auto" style="margin-top:14.60%">
